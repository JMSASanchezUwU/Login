        ...
        <div class="formcontent">
            <form id="formulario_login" runat="server">
                <div class="form-control">
                    ...
                    <div class="row">
                        <div>
                            <asp:Button ID="BtnIngresar" CssClass="btn btn-primary btn-dark" runat="server" Text="Log In" OnClick="BtnIngresar_Click" />
                        </div>
                        <div>
                            <asp:Button ID="BtnRegistrar" CssClass="btn btn-success btn-dark" runat="server" Text="Registrarse" OnClick="BtnRedireccionar_Click" />
                        </div>
                    </div>
                </div>
            </form>
